...
export class UserAnswerExamService {
    ...
    create(userAnswer: UserAnswerExam): Observable<UserAnswerExam> {
    ...
    update(userAnswer: UserAnswerExam): Observable<UserAnswerExam> {
        const copy = this.convert(userAnswer);
    ...
    find(id: number): Observable<UserAnswerExam> {
     ...
     */
    private convertItemFromServer(json: any): UserAnswerExam {
        const entity: UserAnswerExam = Object.assign(new UserAnswerExam(), json);
        return entity;
    }
