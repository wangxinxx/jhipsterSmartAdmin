...
@Component({
    selector: 'jhi-base-question-exam',
    templateUrl: './base-question-exam.component.html'
})
export class BaseQuestionExamComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    trackId(index: number, item: BaseQuestionExam) {
        return item.id;
    }
    ...
    registerChangeInBaseQuestions() {
        this.eventSubscriber = this.eventManager.subscribe('baseQuestionListModification', (response) => this.loadAll());
    }
