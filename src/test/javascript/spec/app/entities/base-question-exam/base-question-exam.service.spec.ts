...
describe('Service Tests', () => {
    ...
    describe('BaseQuestionExam Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BaseQuestionExamService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/base-questions';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BaseQuestionExam', () => {

                let entity: BaseQuestionExam;
                service.find(123).subscribe((_entity: BaseQuestionExam) => {
                    entity = _entity;
                });
