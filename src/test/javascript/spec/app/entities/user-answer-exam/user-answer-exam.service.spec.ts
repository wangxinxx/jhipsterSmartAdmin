...
describe('Service Tests', () => {
    ...
    describe('UserAnswerExam Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(UserAnswerExamService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-answers';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserAnswerExam', () => {

                let entity: UserAnswerExam;
                service.find(123).subscribe((_entity: UserAnswerExam) => {
                    entity = _entity;
                });
