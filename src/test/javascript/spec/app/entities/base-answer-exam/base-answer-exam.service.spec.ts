...
describe('Service Tests', () => {
    ...
    describe('BaseAnswerExam Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(BaseAnswerExamService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/base-answers';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return BaseAnswerExam', () => {

                let entity: BaseAnswerExam;
                service.find(123).subscribe((_entity: BaseAnswerExam) => {
                    entity = _entity;
                });
